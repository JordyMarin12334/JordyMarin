<div style="float:left; width:60%; margin:60px auto; padding:1vw; border-left:1px solid gray; border-right:1px solid gray;">
   <div  style="width: 100%;  ">     
    <div style="width: 100%; height:100%; margin: auto ; display:inline-block;" >
       <div style=" width:100%; height: 100%; top:0; font-size:20px; text-align:center; float:left; ">
        	<h1>¿Quién es Jordy Emanuel. Marin Gonzalez.?</h1>
       		 <hr>
             
          <div id="posteo" style="text-align: left; font-size:0.5vw;">
                Posteado por:  Jordy Marin<br>
                Fecha: 2023-04-30 <br>
          </div>
        </div>
    </div>
  ...
  <div style="width: 100%; height:100%;" >
           <div  style="text-align:justify; font-size: 20px;">
                   <p class="eys-parrafo">Hola, yo soy Jordy Emanuel <b> Marin Gonzalez </b>, Estudiante de ingeneria de la Universidad Luis Vargas torres de Esmeraldas que estudia desde hace 3 años en la Universidad Tecnica Luis Vargas Torres, desde siempre me a gustado la tecnoligia y la informatica por eso escoji esta carrera de tecnologia de la informacion</p>
                   <p class="eys-parrafo">Desde mís estudios secundarios me he apacionado por las ciencias y la tecnología, quieza sería  por esta capacidad que tiene estas dos áres del conocimiento de solucionar muchos probemas de la sociedad; es por eso que desde que termine mis estudios de ingeniería en la UTLVT, me he dedicado a la programación de computadoras. </p>
<p class="eys-parrafo"> El primer lenguaje con el cual empece a programar en el tercer ciclo de universidad fue el <b><a href="https://en.wikipedia.org/wiki/BASIC"> basic</a></b>  para este tiempo la ESPOL contaba con laboratorios de computadora  una computadora personal de marca IBM de tip XT modelo 5160  en es.</p>
   ...
   <div id="blog-seccion2"  style="height: 50px;"></div>
    ...
    <h2 style="border-bottom: 1px solid green;"> Mis estudios</h2> 
                   ...
                   <p class="eys-parrafo">Mis estudios secundarios los realice en el colegio Fisco-Misional    Pierre Thaeiard the Chardin donde me gradue en el año 2019, de la especialidad de Informatica, apenas me gradue entre a la universidad de Esmeraldas UTLVT para seguir mis estudios universitarios en Luis Vargas Torres de Esmeraldas donde seguo la carrera de Ingeniería en Tecnologia de la informacion y comunicacion, gracias a la demanda que exitía en este tiempo de este tipo de profesionales comencé a trabajar mientra estaba estudiando, prestando mis servicios profesionales en empresas como Poligráfica, El telegráfo, Intecorsorcio; mientras trabajaba en esta última logré obtener mi título de Ingeniero de Computación.</p>
